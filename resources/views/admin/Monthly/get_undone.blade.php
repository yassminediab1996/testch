			...
			<div class="card-body">
				<div class="table-responsive">
					<table id="data-table-advance" class="table table-lg table-hover">
						...
						@foreach($getmon as $cat2)
					        @php
					          $cat = App\Monthly::find($cat2->mon_id);
					        @endphp
							<tr>
								...
								@endif
							     <td>
							        ...
							        <a href="#" class="undone"  onclick="undone({{$cat->id}})" title="undone resone" data-toggle="tooltip"><i class="ti-comment"></i></a>
									 @if($permission_list == 0)  
...
<div id="undone_model" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">×</button>
				<h5 class="modal-title">Reasone</h5>
			</div>
