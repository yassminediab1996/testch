...
@media screen and (max-height: 450px) {
  ...
  <div id="mySidenav" class="sidenav" style=" background-color:white;    width: 400px; !important">
    ...
    <div class="row" id="all">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="data-table-advance" class="table table-lg table-hover">
                            ...
                            @php
                             $mon = App\Monthly::find($all->mon_id);
                            
                             $time = strtotime($mon->date);
      ...
      function orderchang(id,order , mon)
      {
           ...
           var id = id ;
        $.get("{{ url('17$es12/map/chngmon') }}?id="+id+"&order="+order+"&monid="+mon, function(data, status) {
            if(data == 1)
            {
                console.log('done');
                $("#id").val(id);
  ...
  $( document ).ready(function() {
    ...
    function openNav(id) {
        ...
        $.get("{{ url('17$es12/map/get_details_mon') }}?id="+id, function(data, status) {
            $( "#get_details" ).empty();
        ...
        <div class="add-popup modal fade" id="addproduct" tabindex="-1" role="dialog" aria-labelledby="addproduct">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{url('17$es12/map/adddetails')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
        ...
        <div class="add-popup modal fade" id="pop_cancel" tabindex="-1" role="dialog" aria-labelledby="addproduct">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{url('17$es12/map/resone_cancel')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
        ...
        <div class="add-popup modal fade" id="undone_cancel" tabindex="-1" role="dialog" aria-labelledby="addproduct">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{url('17$es12/map/resone_undone')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
