                            ...
                            @foreach($subcity as $cat)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('17$es12/city/addstate/'.$cat->id)}}" ><button class="btn btn-md btn-primary" >add state</button></a>
                                    </td>
                                </tr>
                ...
                <form action="{{url('17$es12/city/add')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon br br-light no-br"><i class="ti-user"></i></span>
                                <input type="text" name="fees" class="form-control no-bl" value="" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="exampleSelect1" name="parent">
                                @foreach(App\AdminModel\City::where('parent',0)->get() as $cat)
                ...
                <form action="{{url('17$es12/city/update')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon br br-light no-br"><i class="ti-user"></i></span>
                                <input type="text" name="fees" id="fees" class="form-control no-bl" value="" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exampleSelect1"> select Category</label>
