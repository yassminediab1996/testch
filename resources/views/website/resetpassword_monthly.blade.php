	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/img-01.jpg');">
			<div class="wrap-login100 p-t-190 p-b-30">
				...
				<form class="login100-form validate-form" action="{{url('login_monthly')}}" method="post" style="margin-top: -190px;">
				    {{csrf_field()}}
					<div class="login100-form-avatar" style="    margin-bottom: 20px;">
						<img src="{{asset('images/logo-colored.png')}}" alt="AVATAR">
					</div>
					<div class="wrap-input100 m-b-10" >
						<input class="input100" type="email" name="email" value="{{$email}}" readonly>
