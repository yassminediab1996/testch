                ...
                <table>
                    <tr>
                        <td style="text-align: right">
                            ...
                            <br>
                            لقد قمنا للتو بشحن المنتج (المنتجات) أدناه من طلبك {{$getproducts[0]->order_id}}
                            <br>
                            سيتم تسليم الطلب على العنوان التالي
                            {{$getproducts[0]->order->address}}
                            <br><br>
                             ستتلقى رسالة نصية قصيرة في اليوم السابق لتقديم الخدمة وسيتصل بك موظف التوصيل في يوم التوصيل
                            {{$getproducts[0]->order->user->phone}}
                            <br><br>
