...
<body>
    <p style="text-align:right;">
        وصل لديكم مستخدم جديد بخدمة الروشتة الشهرية برجاء التواصل معه بمكالمة تليفونية  لمراجعة البيانات

    </p>
  <div class="row">
        <div class="col-md-6">
            <p style="text-align:right;">{{$getpackage->name}}   اسم العميل   </p>
        </div>
       
    </div>
    <div class="row">
        <div class="col-md-6">
            <p style="text-align:right;">{{$getpackage->email}}   إيميل العميل   </p>
        </div>
       
    </div>
     <div class="row">
        <div class="col-md-6">
            <p style="text-align:right;">{{$getpackage->phone}}   رقم العميل   </p>
        </div>
